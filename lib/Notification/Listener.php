...
use OCA\Talk\Events\RefreshCallNotificationEvent;
...
class Listener implements IEventListener {
	...
	public function handle(Event $event): void {
		if ($event instanceof RefreshCallNotificationEvent) {
			$this->refreshCallNotification($event->getRoom(), $event->getActor()->getAttendee(), $event->getTarget()->getAttendee());
		}
	}

	public function refreshCallNotification(Room $room, Attendee $actor, Attendee $target): void {
		try {
